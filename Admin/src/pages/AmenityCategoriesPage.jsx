...
const AmenityCategoriesPage = () => {
    ...
    const roomColumns = [{
        title: 'Id', field: 'id', render: rowData => <div style={{ maxWidth: '20px' }}>{rowData.id}</div>,
    }, {
    ...
    const handleSubmit = () => {
        ...
        if (editMode) {
            dispatch(updateAmenityCategory({
                id: amenityCategory.id, name, description
            }))
        } else {
        ...
        <MaterialTable
          title={<div className="flex items-center">
              ...
              <Dialog open={open} onClose={handleClose} className="w-full">
                  <DialogTitle>Add Amenity Category</DialogTitle>
          ...
          options={{
              ...
              }, actionsColumnIndex: -1, pageSizeOptions: [10, 15], pageSize: 10,
          }}
          components={{
