...
export function getElementsOfDate(date) {
    return [
...
const Calendar = ({
    ...
    let firstMonthAndYear;
    let secondMonthAndYear;
    ...
    async function sadf(firstMonthAndYear, secondMonthAndYear) {
    ...
    const fetchDatesInMonth = async (month, year) => {
        const {
    ...
    function getDatesInMonth(daysInMonth, month, year) {
        const date = new Date();
        let daysInMonthJs = [];
